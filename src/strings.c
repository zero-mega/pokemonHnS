...
const u8 gText_WirelessNotConnected[] = _("L’Adaptateur Sans Fil n’est pas\nconnecté.");
const u8 gText_MysteryGiftCantUse[] = _("Le CADEAU MYSTÈRE est indisponible\nquand l’Adaptateur Sans Fil est branché.");
const u8 gText_MysteryEventsCantUse[] = _("Les ÉVÉNEMENTS MYSTÈRE sont indisponibles\nquand l’Adaptateur Sans Fil est branché.");
...
const u8 gText_BatteryRunDry[] = _("La pile interne est épuisée.\nLe jeu peut être joué.\pCependant, les évènements liés à l’horloge\nne se produiront plus.\pIl est recommandé de commencer une nouvelle partie\navec FAKE RTC s’il n’y a pas de pile.");
...
const u8 gText_ThisIsAPokemon[] = _("Voici ce que l’on appelle un « POKéMON ».{PAUSE 96}\p");
...
const u8 gText_DexSortHeaviestTitle[] = _("MODE PLUS LOURD");
const u8 gText_DexSortLightestTitle[] = _("MODE PLUS LÉGER");
const u8 gText_DexSortTallestTitle[] = _("MODE PLUS GRAND");
const u8 gText_DexSortSmallestTitle[] = _("MODE PLUS PETIT");
...
const u8 gText_DexSearchDontSpecify[] = _("SANS PRÉCISER");
...
const u8 gText_MenuOptionSave[] = _("SAUVEGARDE");
