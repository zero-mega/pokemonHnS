...
const u8 gText_GoBackPrevMenu[] = _("Retourner au\nmenu précédent.");
...
const u8 gText_NoRoomForItems[] = _("Il n’y a plus de place\npour stocker des objets.");
...
const u8 gText_SavingDontTurnOff2[] = _("SAUVEGARDE…\nNE PAS ÉTEINDRE LA CONSOLE.");
...
const u8 gText_TextSpeed[] = _("VITESSE TEXTE");
const u8 gText_BattleScene[] = _("ANIM. COMBAT");
const u8 gText_BattleStyle[] = _("STYLE COMBAT");
const u8 gText_Autorun[] = _("COURSE AUTO");
const u8 gText_Sound[] = _("SON");
const u8 gText_Frame[] = _("CADRE");
const u8 gText_OptionMenuCancel[] = _("ANNULER");
const u8 gText_FollowerEnable[] = _("{PKMN} FOLLOWER");  //tx_optionsPlus
const u8 gText_AutorunEnable[] = _("AUTORUN");  //tx_optionsPlus
const u8 gText_OptionMatchCalls[] = _("APPELS DRESSEURS");  //tx_optionsPlus
const u8 gText_OptionMenuSave[] = _("SAUVEGARDE");  //tx_optionsPlus
const u8 gText_OptionStyle[] = _("SÉPARATION ATQ");  //tx_optionsPlus
const u8 gText_OptionDifficulty[] = _("DIFFICULTÉ");  //tx_optionsPlus
const u8 gText_ButtonMode[] = _("MODE BOUTONS");
const u8 gText_TextSpeedSlow[] = _("LENT");
const u8 gText_TextSpeedMid[] = _("MOYEN");
const u8 gText_TextSpeedFast[] = _("RAPIDE");
const u8 gText_BattleSceneOn[] = _("OUI");
const u8 gText_BattleSceneOff[] = _("NON");
const u8 gText_BattleStyleShift[] = _("CHANG.");
const u8 gText_BattleStyleSet[] = _("FIXE");
const u8 gText_SoundMono[] = _("MONO");
const u8 gText_SoundStereo[] = _("STÉRÉO");
...
const u8 gText_MenuRetire[] = _("SE RETIRER");
const u8 gText_MenuRest[] = _("SE REPOSER");
