static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), 25, 45},
    ...
    [HEAL_LOCATION_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER), MAP_NUM(MT_SILVER), 25, 15},
    [HEAL_LOCATION_LAKE_OF_RAGE - 1] = {MAP_GROUP(LAKE_OF_RAGE), MAP_NUM(LAKE_OF_RAGE), 23, 33},
