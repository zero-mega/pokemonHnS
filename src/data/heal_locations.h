static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 18, 7},
    ...
    [HEAL_LOCATION_MAHOGANYTOWN - 1] = {MAP_GROUP(MAHOGANYTOWN), MAP_NUM(MAHOGANYTOWN), 21, 18},
