static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 14, 7},
    [HEAL_LOCATION_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 34, 38},
    [HEAL_LOCATION_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 22, 12},
    [HEAL_LOCATION_GOLDENROD_CITY - 1] = {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY), 18, 37},
    [HEAL_LOCATION_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 31, 34},
    [HEAL_LOCATION_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), 15, 34},
    [HEAL_LOCATION_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY), 31, 44},
    [HEAL_LOCATION_MAHOGANYTOWN - 1] = {MAP_GROUP(MAHOGANYTOWN), MAP_NUM(MAHOGANYTOWN), 17, 18},
    [HEAL_LOCATION_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), 24, 32},
    [HEAL_LOCATION_PALLET_TOWN - 1] = {MAP_GROUP(PALLET_TOWN), MAP_NUM(PALLET_TOWN), 12, 9},
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 25, 25},
    [HEAL_LOCATION_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 17, 27},
    [HEAL_LOCATION_CERULEAN_CITY - 1] = {MAP_GROUP(CERULEAN_CITY), MAP_NUM(CERULEAN_CITY), 22, 20},
    [HEAL_LOCATION_VERMILLION_CITY - 1] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), 18, 7},
    [HEAL_LOCATION_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 7, 6},
    [HEAL_LOCATION_CELADON_CITY - 1] = {MAP_GROUP(CELADON_CITY), MAP_NUM(CELADON_CITY), 34, 11},
    [HEAL_LOCATION_SAFFRON_CITY - 1] = {MAP_GROUP(SAFFRON_CITY), MAP_NUM(SAFFRON_CITY), 24, 39},
    [HEAL_LOCATION_FUCHSIA_CITY - 1] = {MAP_GROUP(FUCHSIA_CITY), MAP_NUM(FUCHSIA_CITY), 20, 30},
    [HEAL_LOCATION_CINNABAR_ISLAND - 1] = {MAP_GROUP(CINNABAR_ISLAND), MAP_NUM(CINNABAR_ISLAND), 17, 11},
    [HEAL_LOCATION_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER), MAP_NUM(MT_SILVER), 28, 20},
    [HEAL_LOCATION_LAKE_OF_RAGE - 1] = {MAP_GROUP(LAKE_OF_RAGE), MAP_NUM(LAKE_OF_RAGE), 20, 30},
    [HEAL_LOCATION_INDIGO_PLATEAU - 1] = {MAP_GROUP(INDIGO_PLATEAU), MAP_NUM(INDIGO_PLATEAU), 11, 7},
    [HEAL_LOCATION_SAFARI_ZONE_GATE - 1] = {MAP_GROUP(SAFARI_ZONE_GATE), MAP_NUM(SAFARI_ZONE_GATE), 6, 11},
    [HEAL_LOCATION_NEW_MAP1 - 1] = {MAP_GROUP(NEW_MAP1), MAP_NUM(NEW_MAP1), 22, 18},
    [HEAL_LOCATION_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 41, 6},
    [HEAL_LOCATION_PLAYERS_HOUSE2 - 1] = {MAP_GROUP(PLAYERS_HOUSE2), MAP_NUM(PLAYERS_HOUSE2), 4, 5},
};
