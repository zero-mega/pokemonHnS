static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 35, 40},
    ...
    [HEAL_LOCATION_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 40, 7},
