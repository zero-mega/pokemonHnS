...
const u8 gEasyChatWord_Sweets[] = _("CONFISERIES");
const u8 gEasyChatWord_Chat[] = _("DISCUSSION");
...
const u8 gEasyChatWord_Shopping[] = _("COURSES");
const u8 gEasyChatWord_Camera[] = _("APPAREIL PHOTO");
const u8 gEasyChatWord_Viewing[] = _("VISIONNEMENT");
...
const u8 gEasyChatWord_Walk[] = _("MARCHE");
...
const u8 gEasyChatWord_Channel[] = _("CHAÎNE");
const u8 gEasyChatWord_Making[] = _("FAIRE");
const u8 gEasyChatWord_Fishing[] = _("PÊCHE");
const u8 gEasyChatWord_Date[] = _("RENDEZ-VOUS / DATE");
