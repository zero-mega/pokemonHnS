const u8 gEasyChatWord_MatchUp[] = _("AFFRONTEMENT");
const u8 gEasyChatWord_Go[] = _("EN AVANT");
const u8 gEasyChatWord_No1[] = _("N° 1");
const u8 gEasyChatWord_Decide[] = _("DÉCIDE");
const u8 gEasyChatWord_LetMeWin[] = _("LAISSE-MOI GAGNER");
const u8 gEasyChatWord_Wins[] = _("GAGNES");
...
const u8 gEasyChatWord_Pushover[] = _("POUSSER / FACILE À VAINCRE");
const u8 gEasyChatWord_Leader[] = _("LEADER");
const u8 gEasyChatWord_Rule[] = _("RÈGLE");
const u8 gEasyChatWord_Move[] = _("BOUGER / MOUVEMENT");
