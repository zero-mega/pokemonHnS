...
const u8 gEasyChatWord_Sometime[] = _("UN DE CES JOURS");
...
const u8 gEasyChatWord_Finish[] = _("FINIR");
...
const u8 gEasyChatWord_Stop[] = _("ARRÊTER");
...
const u8 gEasyChatWord_Daytime[] = _("JOURNÉE");
const u8 gEasyChatWord_Winter[] = _("HIVER");
const u8 gEasyChatWord_Daily[] = _("QUOTIDIEN");
const u8 gEasyChatWord_Olden[] = _("ANCIEN");
const u8 gEasyChatWord_Almost[] = _("QUASIMENT");
const u8 gEasyChatWord_Nearly[] = _("PRESQUE");
const u8 gEasyChatWord_Thursday[] = _("JEUDI");
const u8 gEasyChatWord_Nighttime[] = _("NUIT");
