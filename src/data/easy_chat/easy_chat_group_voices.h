...
const u8 gEasyChatWord_UhOh[] = _("OUPS");
...
const u8 gEasyChatWord_Whoah[] = _("OULA");
const u8 gEasyChatWord_WroooaarExcl[] = _("WROOOAAR!");
const u8 gEasyChatWord_Wow[] = _("WAOUH");
const u8 gEasyChatWord_Giggle[] = _("RIRE");
const u8 gEasyChatWord_Sigh[] = _("SOUFFLE / SIGH");
...
const u8 gEasyChatWord_Snort[] = _("RENIFLE");
