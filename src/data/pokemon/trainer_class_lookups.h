const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_MAGMA_GRUNT_M] = TRAINER_PIC_PETREL,
    [FACILITY_CLASS_EXPERT_M] = TRAINER_PIC_EXPERT_M,
    [FACILITY_CLASS_BLACK_BELT] = TRAINER_PIC_BLACK_BELT,
    [FACILITY_CLASS_AQUA_LEADER_ARCHIE] = TRAINER_PIC_PROTON,
    [FACILITY_CLASS_HEX_MANIAC] = TRAINER_PIC_HEX_MANIAC,
    [FACILITY_CLASS_AROMA_LADY] = TRAINER_PIC_POLICEMAN,
    [FACILITY_CLASS_RUIN_MANIAC] = TRAINER_PIC_RUIN_MANIAC,
    [FACILITY_CLASS_INTERVIEWER] = TRAINER_PIC_FIREBREATHER,
    [FACILITY_CLASS_TUBER_F] = TRAINER_PIC_ENGINEER,
    [FACILITY_CLASS_TUBER_M] = TRAINER_PIC_BURGLAR,
    ...
    [FACILITY_CLASS_MAGMA_GRUNT_F] = TRAINER_PIC_ARIANA,
    [FACILITY_CLASS_GUITARIST] = TRAINER_PIC_GUITARIST,
    [FACILITY_CLASS_KINDLER] = TRAINER_PIC_SUPER_NERD,
    ...
    [FACILITY_CLASS_ELITE_FOUR_SIDNEY] = TRAINER_PIC_ELITE_FOUR_WILL,
    [FACILITY_CLASS_ELITE_FOUR_PHOEBE] = TRAINER_PIC_ELITE_FOUR_KOGA,
    [FACILITY_CLASS_LEADER_ROXANNE] = TRAINER_PIC_LEADER_FALKNER,
    [FACILITY_CLASS_LEADER_BRAWLY] = TRAINER_PIC_LEADER_BUGSY,
    [FACILITY_CLASS_LEADER_TATE] = TRAINER_PIC_LEADER_BLUE, //fix
    ...
    [FACILITY_CLASS_CHAMPION_WALLACE] = TRAINER_PIC_CHAMPION_LANCE,
    [FACILITY_CLASS_FISHERMAN] = TRAINER_PIC_FISHERMAN,
    [FACILITY_CLASS_CYCLING_TRIATHLETE_M] = TRAINER_PIC_KIMONO_GIRL,
    [FACILITY_CLASS_CYCLING_TRIATHLETE_F] = TRAINER_PIC_EUSINE,
    [FACILITY_CLASS_RUNNING_TRIATHLETE_M] = TRAINER_PIC_LEADER_PRYCE,
    [FACILITY_CLASS_RUNNING_TRIATHLETE_F] = TRAINER_PIC_BIKER,
    [FACILITY_CLASS_SWIMMING_TRIATHLETE_M] = TRAINER_PIC_SAGE,
    ...
    [FACILITY_CLASS_MAGMA_LEADER_MAXIE] = TRAINER_PIC_ARCHER,
    ...
    [FACILITY_CLASS_SALON_MAIDEN_ANABEL] = TRAINER_PIC_LEADER_BROCK,
    [FACILITY_CLASS_DOME_ACE_TUCKER] = TRAINER_PIC_LEADER_MISTY,
    ...
    [FACILITY_CLASS_LEADER_WATTSON] = TRAINER_PIC_LEADER_WHITNEY,
    [FACILITY_CLASS_LEADER_FLANNERY] = TRAINER_PIC_LEADER_MORTY,
    [FACILITY_CLASS_LEADER_NORMAN] = TRAINER_PIC_LEADER_JASMINE,
    [FACILITY_CLASS_LEADER_WINONA] = TRAINER_PIC_LEADER_CHUCK,
    [FACILITY_CLASS_LEADER_LIZA] = TRAINER_PIC_LEADER_BLUE, //fix
    [FACILITY_CLASS_LEADER_JUAN] = TRAINER_PIC_LEADER_CLAIR,
    [FACILITY_CLASS_ELITE_FOUR_GLACIA] = TRAINER_PIC_ELITE_FOUR_BRUNO,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_KINDLER] = TRAINER_CLASS_SUPER_NERD,
