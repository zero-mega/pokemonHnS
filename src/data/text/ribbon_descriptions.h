const u8 gRibbonDescriptionPart1_Champion[] = _("Pour avoir battu la LIGUE");
const u8 gRibbonDescriptionPart2_Champion[] = _("et rejoint le PANTHÉON.");
...
const u8 gRibbonDescriptionPart2_NormalRank[] = _("Vainqueur Catégorie Normale !");
const u8 gRibbonDescriptionPart2_SuperRank[] = _("Vainqueur Catégorie Super !");
const u8 gRibbonDescriptionPart2_HyperRank[] = _("Vainqueur Catégorie Hyper !");
const u8 gRibbonDescriptionPart2_MasterRank[] = _("Vainqueur Catégorie Master !");
const u8 gRibbonDescriptionPart1_Winning[] = _("Pour avoir battu la Tour");
const u8 gRibbonDescriptionPart2_Winning[] = _("de Combat niveau 50.");
const u8 gRibbonDescriptionPart1_Victory[] = _("Pour avoir battu la Tour");
const u8 gRibbonDescriptionPart2_Victory[] = _("de Combat niveau Libre.");
const u8 gRibbonDescriptionPart1_Artist[] = _("Pour avoir été choisi");
const u8 gRibbonDescriptionPart2_Artist[] = _("comme modèle d’esquisse.");
const u8 gRibbonDescriptionPart1_Effort[] = _("Pour avoir fait preuve");
const u8 gRibbonDescriptionPart2_Effort[] = _("d’un grand dévouement.");
