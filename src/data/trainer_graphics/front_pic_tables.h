...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(ROCKET_GRUNT_M, gTrainerFrontPic_AquaGruntM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ROCKET_GRUNT_F, gTrainerFrontPic_AquaGruntF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SWIMMER_M, gTrainerFrontPic_SwimmerM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PETREL, gTrainerFrontPic_MagmaGruntM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(EXPERT_M, gTrainerFrontPic_ExpertM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BLAINE, gTrainerFrontPic_AquaAdminM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BLACK_BELT, gTrainerFrontPic_BlackBelt, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MR_FUJI, gTrainerFrontPic_AquaAdminF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(PROTON, gTrainerFrontPic_AquaLeaderArchie, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(FIREBREATHER, gTrainerFrontPic_Interviewer, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ENGINEER, gTrainerFrontPic_TuberF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BURGLAR, gTrainerFrontPic_TuberM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ARIANA, gTrainerFrontPic_MagmaGruntF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GUITARIST, gTrainerFrontPic_Guitarist, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SUPER_NERD, gTrainerFrontPic_Kindler, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ELITE_FOUR_WILL, gTrainerFrontPic_EliteFourSidney, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_KOGA, gTrainerFrontPic_EliteFourPhoebe, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_BRUNO, gTrainerFrontPic_EliteFourGlacia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ELITE_FOUR_KAREN, gTrainerFrontPic_EliteFourDrake, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_FALKNER, gTrainerFrontPic_LeaderRoxanne, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BUGSY, gTrainerFrontPic_LeaderBrawly, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_WHITNEY, gTrainerFrontPic_LeaderWattson, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MORTY, gTrainerFrontPic_LeaderFlannery, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_JASMINE, gTrainerFrontPic_LeaderNorman, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CHUCK, gTrainerFrontPic_LeaderWinona, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BLUE, gTrainerFrontPic_LeaderTateAndLiza, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CLAIR, gTrainerFrontPic_LeaderJuan, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(CHAMPION_LANCE, gTrainerFrontPic_ChampionWallace, TRAINER_PIC_SIZE * 2),
    TRAINER_SPRITE(FISHERMAN, gTrainerFrontPic_Fisherman, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(KIMONO_GIRL, gTrainerFrontPic_CyclingTriathleteM, TRAINER_PIC_SIZE * 2),
    TRAINER_SPRITE(EUSINE, gTrainerFrontPic_CyclingTriathleteF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_PRYCE, gTrainerFrontPic_RunningTriathleteM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BIKER, gTrainerFrontPic_RunningTriathleteF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SAGE, gTrainerFrontPic_SwimmingTriathleteM, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(JUGGLER, gTrainerFrontPic_MagmaAdmin, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(ARCHER, gTrainerFrontPic_MagmaLeaderMaxie, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(LEADER_BROCK, gTrainerFrontPic_SalonMaidenAnabel, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MISTY, gTrainerFrontPic_DomeAceTucker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_SURGE, gTrainerFrontPic_PalaceMavenSpenser, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ERIKA, gTrainerFrontPic_ArenaTycoonGreta, TRAINER_PIC_SIZE * 2),
    TRAINER_SPRITE(LEADER_JANINE, gTrainerFrontPic_FactoryHeadNoland, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_SABRINA, gTrainerFrontPic_PikeQueenLucy, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GIOVANNI, gTrainerFrontPic_PyramidKingBrandon, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(ROCKET_GRUNT_M, gTrainerPalette_AquaGruntM),
    ...
    TRAINER_PAL(ROCKET_GRUNT_F, gTrainerPalette_AquaGruntF),
    TRAINER_PAL(SWIMMER_M, gTrainerPalette_SwimmerM),
    TRAINER_PAL(PETREL, gTrainerPalette_MagmaGruntM),
    TRAINER_PAL(EXPERT_M, gTrainerPalette_ExpertM),
    TRAINER_PAL(LEADER_BLAINE, gTrainerPalette_AquaAdminM),
    TRAINER_PAL(BLACK_BELT, gTrainerPalette_BlackBelt),
    TRAINER_PAL(MR_FUJI, gTrainerPalette_AquaAdminF),
    TRAINER_PAL(PROTON, gTrainerPalette_AquaLeaderArchie),
    ...
    TRAINER_PAL(FIREBREATHER, gTrainerPalette_Interviewer),
    TRAINER_PAL(ENGINEER, gTrainerPalette_TuberF),
    TRAINER_PAL(BURGLAR, gTrainerPalette_TuberM),
    ...
    TRAINER_PAL(ARIANA, gTrainerPalette_MagmaGruntF),
    TRAINER_PAL(GUITARIST, gTrainerPalette_Guitarist),
    TRAINER_PAL(SUPER_NERD, gTrainerPalette_Kindler),
    ...
    TRAINER_PAL(ELITE_FOUR_WILL, gTrainerPalette_EliteFourSidney),
    TRAINER_PAL(ELITE_FOUR_KOGA, gTrainerPalette_EliteFourPhoebe),
    TRAINER_PAL(ELITE_FOUR_BRUNO, gTrainerPalette_EliteFourGlacia),
    TRAINER_PAL(ELITE_FOUR_KAREN, gTrainerPalette_EliteFourDrake),
    TRAINER_PAL(LEADER_FALKNER, gTrainerPalette_LeaderRoxanne),
    TRAINER_PAL(LEADER_BUGSY, gTrainerPalette_LeaderBrawly),
    TRAINER_PAL(LEADER_WHITNEY, gTrainerPalette_LeaderWattson),
    TRAINER_PAL(LEADER_MORTY, gTrainerPalette_LeaderFlannery),
    TRAINER_PAL(LEADER_JASMINE, gTrainerPalette_LeaderNorman),
    TRAINER_PAL(LEADER_CHUCK, gTrainerPalette_LeaderWinona),
    TRAINER_PAL(LEADER_BLUE, gTrainerPalette_LeaderTateAndLiza),
    TRAINER_PAL(LEADER_CLAIR, gTrainerPalette_LeaderJuan),
    ...
    TRAINER_PAL(CHAMPION_LANCE, gTrainerPalette_ChampionWallace),
    TRAINER_PAL(FISHERMAN, gTrainerPalette_Fisherman),
    TRAINER_PAL(KIMONO_GIRL, gTrainerPalette_CyclingTriathleteM),
    TRAINER_PAL(EUSINE, gTrainerPalette_CyclingTriathleteF),
    TRAINER_PAL(LEADER_PRYCE, gTrainerPalette_RunningTriathleteM),
    TRAINER_PAL(BIKER, gTrainerPalette_RunningTriathleteF),
    TRAINER_PAL(SAGE, gTrainerPalette_SwimmingTriathleteM),
    ...
    TRAINER_PAL(JUGGLER, gTrainerPalette_MagmaAdmin),
    ...
    TRAINER_PAL(ARCHER, gTrainerPalette_MagmaLeaderMaxie),
    ...
    TRAINER_PAL(LEADER_BROCK, gTrainerPalette_SalonMaidenAnabel),
    TRAINER_PAL(LEADER_MISTY, gTrainerPalette_DomeAceTucker),
    TRAINER_PAL(LEADER_SURGE, gTrainerPalette_PalaceMavenSpenser),
    TRAINER_PAL(LEADER_ERIKA, gTrainerPalette_ArenaTycoonGreta),
    TRAINER_PAL(LEADER_JANINE, gTrainerPalette_FactoryHeadNoland),
    TRAINER_PAL(LEADER_SABRINA, gTrainerPalette_PikeQueenLucy),
    TRAINER_PAL(GIOVANNI, gTrainerPalette_PyramidKingBrandon),
