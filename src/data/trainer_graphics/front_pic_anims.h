...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_PETREL] = sAnims_MagmaGruntM,
    [TRAINER_PIC_EXPERT_M] = sAnims_ExpertM,
    [TRAINER_PIC_LEADER_BLAINE] = sAnims_AquaAdminM,
    [TRAINER_PIC_BLACK_BELT] = sAnims_BlackBelt,
    [TRAINER_PIC_MR_FUJI] = sAnims_AquaAdminF,
    [TRAINER_PIC_PROTON] = sAnims_AquaLeaderArchie,
    [TRAINER_PIC_HEX_MANIAC] = sAnims_HexManiac,
    [TRAINER_PIC_POLICEMAN] = sAnims_AromaLady,
    [TRAINER_PIC_RUIN_MANIAC] = sAnims_RuinManiac,
    [TRAINER_PIC_FIREBREATHER] = sAnims_Interviewer,
    [TRAINER_PIC_ENGINEER] = sAnims_TuberF,
    [TRAINER_PIC_BURGLAR] = sAnims_TuberM,
    ...
    [TRAINER_PIC_ARIANA] = sAnims_MagmaGruntF,
    [TRAINER_PIC_GUITARIST] = sAnims_Guitarist,
    [TRAINER_PIC_SUPER_NERD] = sAnims_Kindler,
    ...
    [TRAINER_PIC_ELITE_FOUR_WILL] = sAnims_EliteFourSidney,
    [TRAINER_PIC_ELITE_FOUR_KOGA] = sAnims_EliteFourPhoebe,
    [TRAINER_PIC_ELITE_FOUR_BRUNO] = sAnims_EliteFourGlacia,
    [TRAINER_PIC_ELITE_FOUR_KAREN] = sAnims_EliteFourDrake,
    [TRAINER_PIC_LEADER_FALKNER] = sAnims_LeaderRoxanne,
    [TRAINER_PIC_LEADER_BUGSY] = sAnims_LeaderBrawly,
    [TRAINER_PIC_LEADER_WHITNEY] = sAnims_LeaderWattson,
    [TRAINER_PIC_LEADER_MORTY] = sAnims_LeaderFlannery,
    [TRAINER_PIC_LEADER_JASMINE] = sAnims_LeaderNorman,
    [TRAINER_PIC_LEADER_CHUCK] = sAnims_LeaderWinona,
    [TRAINER_PIC_LEADER_BLUE] = sAnims_LeaderTateAndLiza,
    [TRAINER_PIC_LEADER_CLAIR] = sAnims_LeaderJuan,
    ...
    [TRAINER_PIC_CHAMPION_LANCE] = sAnims_ChampionWallace,
    [TRAINER_PIC_FISHERMAN] = sAnims_Fisherman,
    [TRAINER_PIC_KIMONO_GIRL] = sAnims_CyclingTriathleteM,
    [TRAINER_PIC_EUSINE] = sAnims_CyclingTriathleteF,
    [TRAINER_PIC_LEADER_PRYCE] = sAnims_RunningTriathleteM,
    [TRAINER_PIC_BIKER] = sAnims_RunningTriathleteF,
    [TRAINER_PIC_SAGE] = sAnims_SwimmingTriathleteM,
    ...
    [TRAINER_PIC_JUGGLER] = sAnims_MagmaAdmin,
    ...
    [TRAINER_PIC_ARCHER] = sAnims_MagmaLeaderMaxie,
    ...
    [TRAINER_PIC_LEADER_BROCK] = sAnims_SalonMaidenAnabel,
    [TRAINER_PIC_LEADER_MISTY] = sAnims_DomeAceTucker,
    [TRAINER_PIC_LEADER_SURGE] = sAnims_PalaceMavenSpenser,
    [TRAINER_PIC_LEADER_ERIKA] = sAnims_ArenaTycoonGreta,
    [TRAINER_PIC_LEADER_JANINE] = sAnims_FactoryHeadNoland,
    [TRAINER_PIC_LEADER_SABRINA] = sAnims_PikeQueenLucy,
    [TRAINER_PIC_GIOVANNI] = sAnims_PyramidKingBrandon,
