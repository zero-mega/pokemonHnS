...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JERRY] = REMATCH(TRAINER_ARCHER_3, TRAINER_ARCHER_4, TRAINER_ARCHER_5, TRAINER_EXECUTIVE_5, TRAINER_EXECUTIVE_6, ROUTE116),
    ...
    [REMATCH_JENNY] = REMATCH(TRAINER_EXECUTIVE_2, TRAINER_EXECUTIVE_3, TRAINER_EXECUTIVE_4, TRAINER_ARCHER_1, TRAINER_ARCHER_2, ROUTE124),
