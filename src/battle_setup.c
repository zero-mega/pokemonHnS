...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JERRY] = REMATCH(TRAINER_ARCHER_3, TRAINER_ARCHER_4, TRAINER_ARCHER_5, TRAINER_ARCHER_5, TRAINER_ARCHER_5, ROUTE116),
    ...
    [REMATCH_JENNY] = REMATCH(TRAINER_PROTON_1, TRAINER_PROTON_2, TRAINER_ARCHER_5, TRAINER_ARCHER_1, TRAINER_ARCHER_2, ROUTE124),
