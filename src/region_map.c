...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_TOJO_FALLS},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    */
    ...
    [MAPSEC_TOJO_FALLS] = {MAP_GROUP(ROUTE134), MAP_NUM(ROUTE134), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_VERMILION_CITY] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), HEAL_LOCATION_VERMILLION_CITY},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LAVENDER_TOWN:
        return FlagGet(FLAG_VISITED_LAVENDAR_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
